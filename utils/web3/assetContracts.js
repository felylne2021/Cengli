...
const goerliContract = new ethers.Contract("0xA1bD683B06b9B7F633cc7A96A9E5f0AE0662C6C4", USDCTransferCengliABI.abi, goerliSigner);
...
const optimismContract = new ethers.Contract("0xA1bD683B06b9B7F633cc7A96A9E5f0AE0662C6C4", USDCTransferCengliABI.abi, optimismSigner);
...
const arbitrumContract = new ethers.Contract("0xA1bD683B06b9B7F633cc7A96A9E5f0AE0662C6C4", USDCTransferCengliABI.abi, arbitrumSigner);

const avaxProvider = new ethers.JsonRpcProvider(AVAX_API_KEY);
const avaxSigner = new ethers.Wallet(PRIVATE_KEY, avaxProvider);
const avaxContract = new ethers.Contract("0xA1bD683B06b9B7F633cc7A96A9E5f0AE0662C6C4", USDCTransferCengliABI.abi, avaxSigner);
