...
Color softBlueIcon = Color(getColorHexFromStr("#E9FBFF"));
...
Color basicSkeleton = Color(getColorHexFromStr("#EAE9ED"));
Color highlightSkeleton = Color(getColorHexFromStr("#F9F8FA"));
